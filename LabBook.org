...
tilingT.c
#+end_example
* [16:22:11; 14.07.2016] Conversa semanal com Gabriel

Com relação a entrada:
- [[*Definição do assunto da dissertação][Definição do assunto da dissertação]]

Rastreamento com scorep 2.0.2, configurado da seguinte maneira:

#+BEGIN_EXAMPLE
./configure --prefix=/home/schnorr/install/scorep-2.0.2/ --enable-papi
#+END_EXAMPLE
...
hardware que só são capazes de ser lidos pelo superusuário. Uma forma
