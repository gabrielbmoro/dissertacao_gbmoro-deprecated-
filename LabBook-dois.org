	...
	while(count < sizeOfLines) {
		if(count + 1 < sizeOfLines) {
			...
			while(i < nrow) {
				...
				#está no intervalo desejado, serão agrupados os contadores (somados)
				if(df3[i,j] == lines[count] || df3[i,j] == lines[count+1]) {
			...
			m_final[index_final,1] <- lines[count]
			m_final[index_final,2] <- lines[count+1]
...
2  253 266  0.014656     3888     237     59    272  1 parallel
3  266 281  0.015630     3908     225     24    170  1 parallel
4  281 323  1.149141   264294   18450   3962  18889  1 parallel
5  323 344  2.312714   262836   23045   8118  22032  1 parallel
6  344 488  2.398812   541734   27053   2521  20690  1 parallel
7  488 522 95.651829 20356111 1004739 119276 617219  1 parallel
8  522 646  2.619152   538831   30474   3940  18374  1 parallel
9  646 736  0.027157     3793     667    227    594  1 parallel
10 736 836  0.013245     3812     186     59    401  1 parallel
11 836 862  0.022951     3831     439    113    677  1 parallel
12  NA  NA        NA       NA      NA     NA     NA  1 parallel
#+end_example
