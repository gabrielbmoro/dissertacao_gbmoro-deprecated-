...
df1 <- df0 %>%
    rename(
        Type=V1, Container=V2, StateType=V3, Start=V4, End=V5, Duration=V6, Thread=V7, Region=V8,
        Push_PAPI_L2_TCA=V9,
        Push_PAPI_L2_DCM=V10,
        Push_ru_utime=V11,
        Push_ru_stime=V12,
...
#+RESULTS:
#+begin_example
   Type Container StateType        Start          End     Duration Thread
1 State      zero         S     1.040083     1.053624     0.013541      2
2 State      zero         S     1.057177     1.063913     0.006736      2
3 State      zero         S  8345.835045 25213.400111 16867.565066      4
4 State      zero         S 25227.942463 25235.141154     7.198691      5
...
#+begin_src R :results output :session :exports both
df3 <- df2 %>% select(
                   -Type, -Container, -StateType, -Push_PAPI_L2_TCA, 
...
#+RESULTS:
#+begin_example
         Start          End     Duration Thread                   Region
1     1.040083     1.053624     0.013541      2 !$omp parallel @cg.f:185
2     1.057177     1.063913     0.006736      2 !$omp parallel @cg.f:185
3  8345.835045 25213.400111 16867.565066      4  !$omp barrier @cg.f:805
4 25227.942463 25235.141154     7.198691      5  !$omp barrier @cg.f:883
5 25235.153436 25235.189693     0.036257      5  !$omp barrier @cg.f:896
6 28591.264528 28591.299142     0.034614      5  !$omp barrier @cg.f:984
  PAPI_L2_TCA PAPI_L2_DCM ru_utime ru_stime
1         833          88        0        0
2         446          21        0        0
3         590         185     4000        0
...
4                do cg.f  218
5                do cg.f  223
6  implicit barrier cg.f  231
7          parallel cg.f  263
8                do cg.f  263
9  implicit barrier cg.f  269
10         parallel cg.f  277
11               do cg.f  277
12 implicit barrier cg.f  281
13         parallel cg.f  293
14               do cg.f  293
15 implicit barrier cg.f  297
16         parallel cg.f  339
17               do cg.f  339
18 implicit barrier cg.f  345
19         parallel cg.f  361
20               do cg.f  361
21 implicit barrier cg.f  365
22         parallel cg.f  513
23               do cg.f  519
24 implicit barrier cg.f  526
25               do cg.f  533
26 implicit barrier cg.f  537
27           master cg.f  546
28          barrier cg.f  554
29               do cg.f  568
30 implicit barrier cg.f  576
31               do cg.f  617
32 implicit barrier cg.f  621
33               do cg.f  633
34 implicit barrier cg.f  646
35               do cg.f  656
36 implicit barrier cg.f  660
37               do cg.f  671
38 implicit barrier cg.f  679
39               do cg.f  685
40 implicit barrier cg.f  691
41          barrier cg.f  805
42          barrier cg.f  883
43          barrier cg.f  896
44          barrier cg.f  984
45          barrier cg.f  994
46          barrier cg.f 1007
47               do cg.f 1009
48 implicit barrier cg.f 1024
49               do cg.f 1025
50 implicit barrier cg.f 1029
#+end_example
...
- 533 e 537
- 546 e 554 (entre master e barrier - única thread)
- 568 e 576
- 617 e 621
