...
df2$line <- as.numeric(gsub("*[a-z]*|@|:|!\\$|\\.","",df2$Region))
df2$Region <- gsub("*[0-9]*|@[a-z]|!\\$|[a-z]\\.[a-z]|:","",df2$Region)
df2$Region <- gsub("\\ ", "_",df2$Region);

df2 <- df2 %>% select(Start, End, Duration, -Imbrication, Region, line, Thread, MISSES_L2, IPC) %>% as.data.frame();
...
#+RESULTS:
#+begin_example
       Start        End   Duration                Region line Thread  MISSES_L2
1   11.87650   11.89433   0.017836         omp_parallel_  736     40 0.40445269
2   11.89433   11.92660   0.032266               omp_do_  736     40 0.16498316
3   11.92660  221.22084 209.294243 omp_implicit_barrier_  739     40 0.21805556
4  221.22084  221.24101   0.020166               omp_do_  736     40 0.11962617
5  221.24101  221.24811   0.007102         omp_parallel_  736     40 0.09473684
6 8024.99327 8025.06138   0.068103         omp_parallel_  836     40 0.33911672
        IPC
1  4.722222
2 26.333799
3  6.729438
