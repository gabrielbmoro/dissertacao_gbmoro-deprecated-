...
#+begin_src R :results output :session :exports both
df <- read.csv("scripts/execLocal1/cg.B.x-4threads_exp5/traces_parallelregions.csv", header=FALSE, strip.white=TRUE);
#+end_src
...
#+RESULTS:
: Error: Unknown variables: V17, V18, V19, V20.
:      Start       End  Duration      Region MISSES_L2 Thread line
: 1 110365.8 110365.83  0.004344 omp_master_ 0.4929577      2  546
: 2 111077.4 111077.52  0.119266     omp_do_ 1.4808168      2  656
: 3  70646.5  70646.63  0.120836     omp_do_ 1.4634761      2  656
: 4 100444.3 100444.40  0.120005     omp_do_ 1.4877261      2  656
: 5 115396.2 115437.58 41.412308     omp_do_ 0.8110392      2  568
: 6 110365.3 110365.37  0.083634     omp_do_ 8.6798780      2  617

Como podemos ver, temos um erro:

#+BEGIN_EXAMPLE
: Error: Unknown variables: V17, V18, V19, V20.
#+END_EXAMPLE

Isso quer dizer que os dados registrados neste arquivo:
- =scripts/execLocal1/cg.B.x-4threads_exp5/traces_parallelregions.csv=
são diferentes dos dados registrados no experimento do LabBook do Gabriel:
- =scripts/execLocal1/cg.B.x-4threads_exp6/traces_parallelregions.csv=
mas eu não tenho acesso a esse arquivo.
