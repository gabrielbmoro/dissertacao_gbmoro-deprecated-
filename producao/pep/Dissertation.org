...
Esse capítulo apresenta os conceitos básicos que estão relacionados com o trabalho, dentre eles, comportamento de aplicações paralelas, modelos de programação, consumo de energia de aplicações, entre outros.
