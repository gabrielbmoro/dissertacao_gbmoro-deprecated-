...
ScarPhase, a qual utiliza como base um histórico de execução da
aplicação, agrupando em fases, funções do programa que possuem um comportamento
...
acordo como o balanceamento da carga da aplicação, até mesmo para
...
chamada ``gear'', a qual define um ganho entre consumo de energia e
...
programa, utilizando uma análise rigorosa usando a técnica 
#+BEGIN_LaTeX
